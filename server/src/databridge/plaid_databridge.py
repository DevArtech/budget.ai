...
class PlaidDatabridge:
    ...
    def create_link_token(self, user_id: str) -> str:
        ...
        request = LinkTokenCreateRequest(
            ...
            products=[Products("transactions")],  # List of Plaid products you want to use
    ...
    def get_transactions(self, token: str, transaction_request: PlaidTransactionRequest) -> List[Transaction]:
        request = TransactionsGetRequest(
            access_token=token,
            start_date=datetime.strptime(transaction_request.start_date, "%Y-%m-%d").date(),
